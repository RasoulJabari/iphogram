        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (localeInfo != null) {
                    ...
                    builder.setMessage(LocaleController.getString("RestartForApplyChanges", R.string.RestartForApplyChanges) + "\n" + LocaleController.getString("ClickOkToRestart", R.string.ClickOkToRestart));
                    final LocaleController.LocaleInfo finalLocaleInfo = localeInfo;
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {

                            LocaleController.getInstance().applyLanguage(finalLocaleInfo, true);
