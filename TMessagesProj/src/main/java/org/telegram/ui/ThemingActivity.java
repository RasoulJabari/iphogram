...
public class ThemingActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        if (fragmentView == null) {
            ...
            AndroidUtilities.setListViewEdgeEffectColor(listView, /*AvatarDrawable.getProfileBackColorForId(5)*/ preferences.getInt("prefHeaderColor", preferences.getInt("themeColor", AndroidUtilities.defColor)));
