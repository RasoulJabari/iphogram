...
public class Theme {
    ...
    public static void setBubbles(Context context) {
        ...
        String bubble = themePrefs.getString("chatBubbleStyle", ImageListActivity.getBubbleName(6));
    ...
    public static void setChecks(Context context) {
        SharedPreferences themePrefs = ApplicationLoader.applicationContext.getSharedPreferences(AndroidUtilities.THEME_PREFS, AndroidUtilities.THEME_PREFS_MODE);
        String check = themePrefs.getString("chatCheckStyle", ImageListActivity.getCheckName(1));
